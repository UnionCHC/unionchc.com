...
var o40345 = temp__5276__auto__;
var temp__5276__auto____$1 = (o40345["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o40346 = temp__5276__auto____$1;
return (o40346["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39426__auto__ = f;
return (o__39426__auto__["toString"]).call(o__39426__auto__);
} else {
return "";
}
...
try{var o__39426__auto___40349 = t;
(o__39426__auto___40349["cljs$lang$ctorPrWriter"]).call(o__39426__auto___40349,t,writer);
}catch (e40348){var __40350 = e40348;
}
...
var char_code = (function (){var o__39426__auto__ = (new String(char$));
return (o__39426__auto__["charCodeAt"]).call(o__39426__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39426__auto__ = String;
return (o__39426__auto__["fromCharCode"]).call(o__39426__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40351 = num_code;
switch (G__40351) {
case (1):
return (185);
...
var o__39426__auto__ = String;
return (o__39426__auto__["fromCharCode"]).call(o__39426__auto__,superscript_code);
});
/**
...
}catch (e40353){var _e__39433__auto__ = e40353;
return false;
}})())){
...
var vec__40354 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40354,(0),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var o40357 = temp__5276__auto__;
var temp__5276__auto____$1 = (o40357["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o40358 = temp__5276__auto____$1;
return (o40358["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31325__auto___40365 = arguments.length;
var i__31326__auto___40366 = (0);
while(true){
if((i__31326__auto___40366 < len__31325__auto___40365)){
args__31332__auto__.push((arguments[i__31326__auto___40366]));

var G__40367 = (i__31326__auto___40366 + (1));
i__31326__auto___40366 = G__40367;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40361){
var vec__40362 = p__40361;
var ns_detector = cljs.core.nth.call(null,vec__40362,(0),null);
...
var G__40368 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40369 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40368;
remaining_tokens = G__40369;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40359){
var G__40360 = cljs.core.first.call(null,seq40359);
var seq40359__$1 = cljs.core.next.call(null,seq40359);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40360,seq40359__$1);
});
...
var vec__40373 = cljs.core.split_with.call(null,(function (p1__40372_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40372_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40373,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40373,(1),null);
...
var vec__40376 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40376,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40376,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40379 = cljs.core.rest.call(null,remaining_tokens);
var G__40380 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40379;
name_tokens = G__40380;
continue;
} else {
...
var vec__40383 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40383,(0),null);
var arity = cljs.core.nth.call(null,vec__40383,(1),null);
var vec__40386 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40386,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40386,(1),null);
var vec__40389 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40389,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40389,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40389,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40389,(3),null);
...
var vec__40395 = result;
var munged_ns = cljs.core.nth.call(null,vec__40395,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40395,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40395,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40395,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40395,(4),null);
var arity = cljs.core.nth.call(null,vec__40395,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__40399 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__40399,(0),null);
var args = cljs.core.nth.call(null,vec__40399,(1),null);
var vec__40402 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40402,(0),null);
var name = cljs.core.nth.call(null,vec__40402,(1),null);
...
var G__40405 = (arity + (1));
var G__40406 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40407){
var vec__40408 = p__40407;
var arity = cljs.core.nth.call(null,vec__40408,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40408,(1),null);
...
return (function (p1__40411_SHARP_){
return cljs.core.get.call(null,arities,p1__40411_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40412_SHARP_);
...
var args__31332__auto__ = [];
var len__31325__auto___40419 = arguments.length;
var i__31326__auto___40420 = (0);
while(true){
if((i__31326__auto___40420 < len__31325__auto___40419)){
args__31332__auto__.push((arguments[i__31326__auto___40420]));

var G__40421 = (i__31326__auto___40420 + (1));
i__31326__auto___40420 = G__40421;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40415){
var vec__40416 = p__40415;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40416,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40413){
var G__40414 = cljs.core.first.call(null,seq40413);
var seq40413__$1 = cljs.core.next.call(null,seq40413);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40414,seq40413__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__40424__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40424__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40424__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40424__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40425 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40425,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40425,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40425,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40425,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40425,(4),null);
var arity = cljs.core.nth.call(null,vec__40425,(5),null);
...
var o__39426__auto__ = f;
return (o__39426__auto__["getBasis"]).call(o__39426__auto__);
});
/**
...
}catch (e40429){var _e__39433__auto__ = e40429;
...
var G__40430 = (obj[cljs.core.first.call(null,path)]);
var G__40431 = cljs.core.rest.call(null,path);
obj = G__40430;
path = G__40431;
continue;
} else {
...
return (function (accum,p__40432){
var vec__40433 = p__40432;
var bit = cljs.core.nth.call(null,vec__40433,(0),null);
var protocol = cljs.core.nth.call(null,vec__40433,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40436){
var vec__40437 = p__40436;
var ns = cljs.core.nth.call(null,vec__40437,(0),null);
var name = cljs.core.nth.call(null,vec__40437,(1),null);
var selector = cljs.core.nth.call(null,vec__40437,(2),null);
...
return (function (p__40441){
var vec__40442 = p__40441;
var munged_name = cljs.core.nth.call(null,vec__40442,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40442,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40442,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40440_SHARP_){
return (obj[cljs.core.first.call(null,p1__40440_SHARP_)]);
});})(name,sorted_matches,vec__40442,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503492623478
