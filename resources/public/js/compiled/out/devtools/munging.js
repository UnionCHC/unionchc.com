...
var o41448 = temp__5276__auto__;
var temp__5276__auto____$1 = (o41448["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o41449 = temp__5276__auto____$1;
return (o41449["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40527__auto__ = f;
return (o__40527__auto__["toString"]).call(o__40527__auto__);
} else {
return "";
}
}catch (e41450){var _ = e41450;
return "";
}});
...
try{var o__40527__auto___41452 = t;
(o__40527__auto___41452["cljs$lang$ctorPrWriter"]).call(o__40527__auto___41452,t,writer);
}catch (e41451){var __41453 = e41451;
}
...
var char_code = (function (){var o__40527__auto__ = (new String(char$));
return (o__40527__auto__["charCodeAt"]).call(o__40527__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40527__auto__ = String;
return (o__40527__auto__["fromCharCode"]).call(o__40527__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41454 = num_code;
switch (G__41454) {
case (1):
return (185);
...
var o__40527__auto__ = String;
return (o__40527__auto__["fromCharCode"]).call(o__40527__auto__,superscript_code);
});
/**
...
}catch (e41456){var _e__40534__auto__ = e41456;
return false;
}})())){
...
var vec__41457 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__41457,(0),null);
...
var or__30349__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o41460 = temp__5276__auto__;
var temp__5276__auto____$1 = (o41460["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o41461 = temp__5276__auto____$1;
return (o41461["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31626__auto___41468 = arguments.length;
var i__31627__auto___41469 = (0);
while(true){
if((i__31627__auto___41469 < len__31626__auto___41468)){
args__31633__auto__.push((arguments[i__31627__auto___41469]));

var G__41470 = (i__31627__auto___41469 + (1));
i__31627__auto___41469 = G__41470;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31634__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41464){
var vec__41465 = p__41464;
var ns_detector = cljs.core.nth.call(null,vec__41465,(0),null);
var effective_detector = (function (){var or__30349__auto__ = ns_detector;
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
...
var G__41471 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__41472 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__41471;
remaining_tokens = G__41472;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41462){
var G__41463 = cljs.core.first.call(null,seq41462);
var seq41462__$1 = cljs.core.next.call(null,seq41462);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__41463,seq41462__$1);
});
...
var vec__41476 = cljs.core.split_with.call(null,(function (p1__41475_SHARP_){
return cljs.core.not_EQ_.call(null,p1__41475_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__41476,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__41476,(1),null);
...
var vec__41479 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__41479,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__41479,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__41482 = cljs.core.rest.call(null,remaining_tokens);
var G__41483 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__41482;
name_tokens = G__41483;
continue;
} else {
...
var vec__41486 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__41486,(0),null);
var arity = cljs.core.nth.call(null,vec__41486,(1),null);
var vec__41489 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__41489,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__41489,(1),null);
var vec__41492 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__41492,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__41492,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__41492,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__41492,(3),null);
...
var vec__41498 = result;
var munged_ns = cljs.core.nth.call(null,vec__41498,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__41498,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__41498,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__41498,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__41498,(4),null);
var arity = cljs.core.nth.call(null,vec__41498,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__41502 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__41502,(0),null);
var args = cljs.core.nth.call(null,vec__41502,(1),null);
var vec__41505 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__41505,(0),null);
var name = cljs.core.nth.call(null,vec__41505,(1),null);
...
var G__41508 = (arity + (1));
var G__41509 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41510){
var vec__41511 = p__41510;
var arity = cljs.core.nth.call(null,vec__41511,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__41511,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30349__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__41514_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__41515_SHARP_);
...
var args__31633__auto__ = [];
var len__31626__auto___41522 = arguments.length;
var i__31627__auto___41523 = (0);
while(true){
if((i__31627__auto___41523 < len__31626__auto___41522)){
args__31633__auto__.push((arguments[i__31627__auto___41523]));

var G__41524 = (i__31627__auto___41523 + (1));
i__31627__auto___41523 = G__41524;
continue;
} else {
}
break;
...
var argseq__31634__auto__ = ((((1) < args__31633__auto__.length))?(new cljs.core.IndexedSeq(args__31633__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31634__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41518){
var vec__41519 = p__41518;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__41519,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41516){
var G__41517 = cljs.core.first.call(null,seq41516);
var seq41516__$1 = cljs.core.next.call(null,seq41516);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__41517,seq41516__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30349__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30337__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30349__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__41527__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__41527__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__41527__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__41527__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41528 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__41528,(0),null);
var fn_name = cljs.core.nth.call(null,vec__41528,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__41528,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__41528,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__41528,(4),null);
var arity = cljs.core.nth.call(null,vec__41528,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30337__auto__ = protocol_ns;
if(cljs.core.truth_(and__30337__auto__)){
return cljs.core.not.call(null,(function (){var and__30337__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30349__auto__ = protocol_part;
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
return fn_part;
...
var o__40527__auto__ = f;
return (o__40527__auto__["getBasis"]).call(o__40527__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30337__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30337__auto__)){
...
}catch (e41532){var _e__40534__auto__ = e41532;
...
var G__41533 = (obj[cljs.core.first.call(null,path)]);
var G__41534 = cljs.core.rest.call(null,path);
obj = G__41533;
path = G__41534;
continue;
} else {
...
var partition_bits = (function (){var or__30349__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
return (0);
...
return (function (accum,p__41535){
var vec__41536 = p__41535;
var bit = cljs.core.nth.call(null,vec__41536,(0),null);
var protocol = cljs.core.nth.call(null,vec__41536,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41539){
var vec__41540 = p__41539;
var ns = cljs.core.nth.call(null,vec__41540,(0),null);
var name = cljs.core.nth.call(null,vec__41540,(1),null);
var selector = cljs.core.nth.call(null,vec__41540,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__41545,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__41545,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__41545,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41543_SHARP_){
return (obj[cljs.core.first.call(null,p1__41543_SHARP_)]);
});})(name,sorted_matches,vec__41545,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503547310194
