...
var o40343 = temp__5276__auto__;
var temp__5276__auto____$1 = (o40343["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o40344 = temp__5276__auto____$1;
return (o40344["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39424__auto__ = f;
return (o__39424__auto__["toString"]).call(o__39424__auto__);
} else {
return "";
}
...
try{var o__39424__auto___40347 = t;
(o__39424__auto___40347["cljs$lang$ctorPrWriter"]).call(o__39424__auto___40347,t,writer);
}catch (e40346){var __40348 = e40346;
}
...
var char_code = (function (){var o__39424__auto__ = (new String(char$));
return (o__39424__auto__["charCodeAt"]).call(o__39424__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39424__auto__ = String;
return (o__39424__auto__["fromCharCode"]).call(o__39424__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40349 = num_code;
switch (G__40349) {
case (1):
return (185);
...
var o__39424__auto__ = String;
return (o__39424__auto__["fromCharCode"]).call(o__39424__auto__,superscript_code);
});
/**
...
}catch (e40351){var _e__39431__auto__ = e40351;
return false;
}})())){
...
var vec__40352 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40352,(0),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var o40355 = temp__5276__auto__;
var temp__5276__auto____$1 = (o40355["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o40356 = temp__5276__auto____$1;
return (o40356["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31325__auto___40363 = arguments.length;
var i__31326__auto___40364 = (0);
while(true){
if((i__31326__auto___40364 < len__31325__auto___40363)){
args__31332__auto__.push((arguments[i__31326__auto___40364]));

var G__40365 = (i__31326__auto___40364 + (1));
i__31326__auto___40364 = G__40365;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40359){
var vec__40360 = p__40359;
var ns_detector = cljs.core.nth.call(null,vec__40360,(0),null);
...
var G__40366 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40367 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40366;
remaining_tokens = G__40367;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40357){
var G__40358 = cljs.core.first.call(null,seq40357);
var seq40357__$1 = cljs.core.next.call(null,seq40357);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40358,seq40357__$1);
});
...
var vec__40371 = cljs.core.split_with.call(null,(function (p1__40370_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40370_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40371,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40371,(1),null);
...
var vec__40374 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40374,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40374,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40377 = cljs.core.rest.call(null,remaining_tokens);
var G__40378 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40377;
name_tokens = G__40378;
continue;
} else {
...
var vec__40381 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40381,(0),null);
var arity = cljs.core.nth.call(null,vec__40381,(1),null);
var vec__40384 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40384,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40384,(1),null);
var vec__40387 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40387,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40387,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40387,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40387,(3),null);
...
var vec__40393 = result;
var munged_ns = cljs.core.nth.call(null,vec__40393,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40393,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40393,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40393,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40393,(4),null);
var arity = cljs.core.nth.call(null,vec__40393,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__40397 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__40397,(0),null);
var args = cljs.core.nth.call(null,vec__40397,(1),null);
var vec__40400 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40400,(0),null);
var name = cljs.core.nth.call(null,vec__40400,(1),null);
...
var G__40403 = (arity + (1));
var G__40404 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40405){
var vec__40406 = p__40405;
var arity = cljs.core.nth.call(null,vec__40406,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40406,(1),null);
...
return (function (p1__40409_SHARP_){
return cljs.core.get.call(null,arities,p1__40409_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40410_SHARP_);
...
var args__31332__auto__ = [];
var len__31325__auto___40417 = arguments.length;
var i__31326__auto___40418 = (0);
while(true){
if((i__31326__auto___40418 < len__31325__auto___40417)){
args__31332__auto__.push((arguments[i__31326__auto___40418]));

var G__40419 = (i__31326__auto___40418 + (1));
i__31326__auto___40418 = G__40419;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40413){
var vec__40414 = p__40413;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40414,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40411){
var G__40412 = cljs.core.first.call(null,seq40411);
var seq40411__$1 = cljs.core.next.call(null,seq40411);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40412,seq40411__$1);
});
...
var map__40422 = options;
var map__40422__$1 = ((((!((map__40422 == null)))?((((map__40422.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40422.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40422):map__40422);
var include_ns_QMARK_ = cljs.core.get.call(null,map__40422__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40422__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40422__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40422__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40423 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40423,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40423,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40423,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40423,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40423,(4),null);
var arity = cljs.core.nth.call(null,vec__40423,(5),null);
...
var o__39424__auto__ = f;
return (o__39424__auto__["getBasis"]).call(o__39424__auto__);
});
/**
...
}catch (e40427){var _e__39431__auto__ = e40427;
...
var G__40428 = (obj[cljs.core.first.call(null,path)]);
...
return (function (accum,p__40430){
var vec__40431 = p__40430;
var bit = cljs.core.nth.call(null,vec__40431,(0),null);
var protocol = cljs.core.nth.call(null,vec__40431,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40434){
var vec__40435 = p__40434;
var ns = cljs.core.nth.call(null,vec__40435,(0),null);
var name = cljs.core.nth.call(null,vec__40435,(1),null);
var selector = cljs.core.nth.call(null,vec__40435,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__40440,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40440,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40440,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40438_SHARP_){
return (obj[cljs.core.first.call(null,p1__40438_SHARP_)]);
});})(name,sorted_matches,vec__40440,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503485734295
