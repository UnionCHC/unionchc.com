...
var reader = (function (){var or__30349__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30349__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30349__auto__)){
return or__30349__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__43345__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__43345__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__43345__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e43344){var _e = e43344;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___43347 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___43347)){
var seen_errors_43348 = temp__5276__auto___43347;
if(cljs.core.truth_(seen_errors_43348.has(self))){
} else {
seen_errors_43348.add(self);

var temp__5278__auto___43349 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___43349)){
var sense_43350 = temp__5278__auto___43349;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_43350)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1503547313543
