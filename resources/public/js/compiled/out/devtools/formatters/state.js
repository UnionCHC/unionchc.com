...
var len__31626__auto___41570 = arguments.length;
var i__31627__auto___41571 = (0);
while(true){
if((i__31627__auto___41571 < len__31626__auto___41570)){
args__31633__auto__.push((arguments[i__31627__auto___41571]));

var G__41572 = (i__31627__auto___41571 + (1));
i__31627__auto___41571 = G__41572;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31634__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq41568){
var G__41569 = cljs.core.first.call(null,seq41568);
var seq41568__$1 = cljs.core.next.call(null,seq41568);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__41569,seq41568__$1);
});
...
return (p1__41573_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1503547310307
