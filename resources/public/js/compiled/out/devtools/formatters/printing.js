...
var len__31325__auto___40474 = arguments.length;
var i__31326__auto___40475 = (0);
while(true){
if((i__31326__auto___40475 < len__31325__auto___40474)){
args__31332__auto__.push((arguments[i__31326__auto___40475]));

var G__40476 = (i__31326__auto___40475 + (1));
i__31326__auto___40475 = G__40476;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40471){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40472,G__40473,seq40471__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40477_SHARP_){
return !((cljs.core.meta.call(null,p1__40477_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__40478__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e40482){var _e__39431__auto__ = e40482;
return false;
}})();
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
...
}catch (e40484){var _e__39431__auto__ = e40484;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40486 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40487 = opts;
var map__40487__$1 = ((((!((map__40487 == null)))?((((map__40487.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40487.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40487):map__40487);
var markup_db = cljs.core.get.call(null,map__40487__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40486;
}});
...
;
var temp__5276__auto___40491 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___40491)){
var managed_print_level_40492 = temp__5276__auto___40491;
var _STAR_print_level_STAR_40490_40493 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40492;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40490_40493,managed_print_level_40492,temp__5276__auto___40491,writer,opts,job_fn){
return (function (p1__40489_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40489_SHARP_,null);
});})(_STAR_print_level_STAR_40490_40493,managed_print_level_40492,temp__5276__auto___40491,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40490_40493;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1503485734499
