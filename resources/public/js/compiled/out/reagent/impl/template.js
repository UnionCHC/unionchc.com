...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30719__auto__,writer__30720__auto__,opt__30721__auto__){
return cljs.core._write.call(null,writer__30720__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__32544 = o;
(G__32544[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__32550 = jsprops;
(G__32550["defaultValue"] = value);

(G__32550["onChange"] = ((function (G__32550,v,value,on_change){
return (function (p1__32549_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32549_SHARP_);
});})(G__32550,v,value,on_change))
);
...
var vec__32553 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32553,(0),null);
var id = cljs.core.nth.call(null,vec__32553,(1),null);
var class$ = cljs.core.nth.call(null,vec__32553,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___32557 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___32557 == null)){
} else {
var key_32558 = temp__5282__auto___32557;
(jsprops["key"] = key_32558);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32559 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__32559["name"] = c);
...
var len__31325__auto___32564 = arguments.length;
var i__31326__auto___32565 = (0);
while(true){
if((i__31326__auto___32565 < len__31325__auto___32564)){
args__31332__auto__.push((arguments[i__31326__auto___32565]));

var G__32566 = (i__31326__auto___32565 + (1));
i__31326__auto___32565 = G__32566;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31333__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32562){
var G__32563 = cljs.core.first.call(null,seq32562);
var seq32562__$1 = cljs.core.next.call(null,seq32562);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32563,seq32562__$1);
});
...
var n__31091__auto___32571 = a.length;
var i_32572 = (0);
while(true){
if((i_32572 < n__31091__auto___32571)){
(a[i_32572] = reagent.impl.template.as_element.call(null,(a[i_32572])));

var G__32573 = (i_32572 + (1));
i_32572 = G__32573;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31091__auto___32574 = a.length;
var i_32575 = (0);
while(true){
if((i_32575 < n__31091__auto___32574)){
var val_32576 = (a[i_32575]);
if((cljs.core.vector_QMARK_.call(null,val_32576)) && ((reagent.impl.template.key_from_vec.call(null,val_32576) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32575] = reagent.impl.template.as_element.call(null,val_32576));

var G__32577 = (i_32575 + (1));
i_32575 = G__32577;
continue;
} else {
}
...
var ctx = ({});
var vec__32578 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__32578,(0),null);
var derefed = cljs.core.nth.call(null,vec__32578,(1),null);
...
var G__32581 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32581) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32581){
...
//# sourceMappingURL=template.js.map?rel=1503485725563
